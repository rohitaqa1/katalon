...
WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/span_Jul'))

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_18'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'make automation')
